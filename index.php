<!-- Task Manager Project By Joyanta Mondal -->
<?php
...
//assending order date upcoming task
    ...
    <div class="container" id="main">
        ...
        while($cData=mysqli_fetch_assoc($resultCompleteTasks)){
            ...
            <tr>
                ...
                <td><a class="delete" data-taskid="<?php echo $cData['id']; ?>" href='#'>Delete</a> | <a class="incomplete" data-taskid="<?php echo $cData['id']; ?>" href='#'>Mark Incomplete</a>
                </td>
            </tr>
        <?php
